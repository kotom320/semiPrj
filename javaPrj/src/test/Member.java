...
public class Member extends JFrame implements ActionListener, ItemListener {
	Data da = new Data();
	ConnectPg con;
	...
	public Member() {
		...
		firstPanel.setLayout(new GridLayout(4, 0, 10, 10));
		firstPanel.add(p1);
		firstPanel.add(p2);
		firstPanel.add(p3);
		firstPanel.add(p4);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals("확인")) {
			...
			if (fPass.getText().equals("")) {
				...
				JOptionPane.showMessageDialog(null, "암호가 일치합니다.");
			} else {
				JOptionPane.showMessageDialog(null, "암호를 다시 확인해 주세요");
			}
